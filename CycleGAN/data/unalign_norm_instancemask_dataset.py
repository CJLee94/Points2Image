...
class UnalignNormInstanceMaskDataset(BaseDataset):
    """
    Load unaligned hv+seg/ image crops. The binary seg is additionally normalized to [-1,1] for CycleGAN
    """
    @staticmethod
    ...
    def __getitem__(self, index):
        ...
        A_instance = A[0].numpy().astype(np.uint8)
